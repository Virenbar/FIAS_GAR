...
3. Выбрать субъекты РФ для импорта
4. Указать в настройках каталог для хранения данных (**`<path>`**) и снять выбор с ненужных таблиц
...
2. Запустить FIASUpdate
3. Нажать `Импорт полной копии БД`
4. Выбрать файл архива (Можно переташить на текстовое поле)
5. Нажать `Импортировать` и дождаться завершения импорта

![import](../assets/fias/import-full.png)
